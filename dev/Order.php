<?php
	class Order extends Account{		
		...
		{
			$db = Database::getInstance()->getConnection();
			$query = $db->prepare("INSERT INTO customer_order (customer_id, order_id, paystack_reference, paid_status, order_status, subtotal, shipping_charge, amount) VALUES (:customer_id, :order_id, :paystack_reference, :paid_status, :order_status, :subtotal, :shipping_charge, :amount)");
