...
//$roll = $product->getCusCompProduct($customer_id);
?>
    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span><?php echo $name ?> Compared Products</span></li>
            </ul>
        </div>
        <div class="row">
                ...
                if($totalItems ==0){ ?>
                    ...
                    <div class="row">
                        <div class="wrap-show-advance-info-box style-1 has-countdown">
						    <h3 class="title-box"><?php echo "$name"; ?> Product Compared List</h3>
						    ...
						    <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'><?PHP
						    	foreach($product->getCusCompProduct($customer_id) as $seewish){
	                                $slug = $seewish['slug'];
							                ...
							                <div class="product-info">
							                    ...
							                    <div class="wrap-price"><ins><p class="product-price">
							                     ...
							                     <div class="wrap-btn">
                                                    ...
                                                    <a href="handlers/registration/addit.php?slug=<?php echo $listThr['slug'] ?>&&list_id=<?php  echo $seewish['list_id']; ?>&&action=<?php echo 'Delete Compare' ?>" 
