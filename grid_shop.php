        ...
        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
            ...
            <div class="banner-shop" align="center">
                <a href="grid_shop.php" class="banner-link">
                    <figure><img src="assets/images/stationary 2.jpg" style="1200px" alt=""></figure>
                </a>
            </div>
            ...
            <div class="wrap-shop-control">
                ...
                <div class="wrap-right">
                    ...
                    <div class="change-display-mode">
                        <a href="grid_shop.php" class="grid-mode display-mode active"><i class="flaticon-squares"></i>Grid</a>
                        <a href="list_shop.php" class="list-mode display-mode"><i class="flaticon-interface"></i>List</a>
                    </div>
